...
contract TicketingSystem {
    ...
    function setTicketForSale(uint256 ticketId, uint256 price)
        public
...
function listTicketForSecondarySale(uint256 ticketId, uint256 price)
        public
        onlyTicketOwner(ticketId)
    {
    ...
    // Transfer the secondary market fee to the organizer
